...
public class FileOperations {
    private static final String INPUT_FILE_NAME = "F:\\Level 1 Term 2 materials\\CSE 108\\JavaFx Projects\\JavaFxP2\\src\\List\\players.txt";
    private static final String OUTPUT_FILE_NAME = "F:\\Level 1 Term 2 materials\\CSE 108\\JavaFx Projects\\JavaFxP2\\src\\List\\playersout.txt";

    private List<Player>playerList1;

    private List<PlayerFx>playerList2;
    ...
    public List getplayerList() throws Exception {
        playerList1 = readFromFile();
        return this.playerList1;

    }

    /*public List getPlayerList2() throws Exception{
        playerList2 = readFromFile();
